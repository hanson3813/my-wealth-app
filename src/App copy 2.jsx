...
export default function App() {
  ...
  if (!user) return (
    <div className="min-h-screen bg-[#050505] flex items-center justify-center text-indigo-500 font-bold tracking-widest text-xl animate-pulse">PORTFOLIO</div>
  );
      ...
      <nav className="max-w-xl mx-auto px-5 pt-5 pb-0 sticky top-0 z-50"
        ...
        <div className="flex items-center gap-2 mb-3">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            {/* 登出 */}
            <button onClick={() => supabase.auth.signOut()} className="p-2.5 rounded-full text-gray-500 hover:text-rose-400 hover:bg-rose-500/5 transition-all">
              <LogOut size={17} />
            </button>
          </div>
        </div>
